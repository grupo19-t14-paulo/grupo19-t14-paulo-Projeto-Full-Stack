...
const RegisterForm = () => {
    ...
    return(
        <Form onSubmit={handleSubmit(submit)}>
            ...
            <Input label="Nome" type="text" id="name" placeholder="Ex: Samuel Leão" {...register("name")} error={errors.name}/>

            <Input label="E-mail" type="email" id="email" placeholder="Ex: samuel@kenzie.com.br" {...register("email")} error={errors.email} />

            <Input label="CPF" type="text" id="cpf" placeholder="000.000.000-00" {...register("cpf")} error={errors.cpf} />

            <Input label="Celular" type="text" id="phone" placeholder="(DDD) 90000-0000" {...register("phone")} error={errors.phone} />

            <Input label="Data de nascimento" type="date" id="birthDate" placeholder="00/00/00" {...register("birthDate")} error={errors.birthDate} />
            ...
            <Input label="Senha" type="password" id="password" placeholder="Digitar senha" {...register("password")} error={errors.password}/>

            <Input label="Confirmar Senha" type="password" id="confirm" placeholder="Digitar senha" {...register("confirm")} error={errors.confirm}/>
