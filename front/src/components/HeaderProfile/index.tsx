...
const HeaderProfile = (props: IHeaderProps) => {
  ...
  return (
    <ConteinerHeader>
      <ModalMenuProfile
        modalOpenMenuProfile={modalOpenMenuProfile}
        setModalOpenMenuProfile={setModalOpenMenuProfile}
      />
      ...
      {token ? (
        <ConteinerButtonHeaderProfile>
          ...
          <ButtonName onClick={() => Menu()}>
            {userNameHeader2 && userNameHeader2.replace("undefined", "").trim()}
          </ButtonName>
        </ConteinerButtonHeaderProfile>
      ) : (
        <div>
